      ...
      <Section className={classes.root} id="imprint" title="Impressum">
        ...
        <div className={classes.item}>
          <div className={classes.item__container}>
            ...
            <br />
            <br />
            Haftung für Inhalte: Im Sinne von § 7 Absatz 1 TMG sind wir für die eigenen Inhalte auf
            dieser Webseite verantwortlich. Durch §§ 8 bis einschließlich 10 TMG sind wir aber nicht
            verpflichtet, gespeicherte oder übermittelte fremde Inhalte zu überwachen oder diese auf
            Rechtswidrigkeit zu prüfen. Das befreit uns jedoch nicht von der Pflicht, der Sperrung
