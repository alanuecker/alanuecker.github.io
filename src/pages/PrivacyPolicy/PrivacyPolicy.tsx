...
export function PrivacyPolicy(): React.JSX.Element {
  return (
    <Section className={classes.root} id="privacy" title="Datenschutzerklärung">
      ...
      <div className={classes.item}>
        <div className={classes.item__container}>
          ...
          <p>
            Weitere Informationen zu Widerspruchs- und Beseitigungsmöglichkeiten gegenüber GitHub
            finden Sie unter:
          ...
          <p>
            Sie haben das Recht der Verarbeitung zu widersprechen. Ob der Widerspruch erfolgreich
          ...
          <p>E-Mail: uecker.alan@gmail.com</p>
          <p>
